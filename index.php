...
$faqs = [
    [
        'domanda' => "Come state implementando la recente decisione della <span>Corte di giustizia dell'Unione europea </span>(CGUE) relativa al diritto all'oblio?",
        'risposta' => [
            "La recente decisione della <a>Corte di giustizia dell'Unione europea</a> ha profonde conseguenze per i motori di ricerca in Europa. La  Corte ha stabilito che alcuni utenti hanno il diritto di chiedere ai motori di ricerca come Google di rimuovere risultati relativi a chiavi di ricerca che includono il proprio nome. Per poter essere rimossi, i risultati visualizzati devono essere inadeguati, irrilevanti o non più rilevanti, o eccessivi.",
